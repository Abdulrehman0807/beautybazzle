...
class HomeCareServiceScreen extends StatefulWidget {
  const HomeCareServiceScreen({super.key});

  @override
  State<HomeCareServiceScreen> createState() => _HomeCareServiceScreenState();
}

class _HomeCareServiceScreenState extends State<HomeCareServiceScreen> {
  var rating = 4.0;
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  children: [
                    TextSpan(
                      text: "Pro Care at Home Specialists ",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: width * 0.05,
